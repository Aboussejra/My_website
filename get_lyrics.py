...
# -*- coding: utf-8 -*-
"""
Created on Tue Mar 30 19:28:14 2021
...
defaults = {
    'request': {
        'token': 'tiLtZeHY0apIkroH2ldkquviNekcDluSGc0cOAmPF6L8KmXW9kkCrPuNuLe5g85t',
...
def scrap_song_url(url):
    ...
    lyrics = None
    tries = 0
    while lyrics is None and tries < 10:
        try:
            lyrics = html.find('div', class_='lyrics').get_text()
            tries = tries + 1
        except AttributeError:
            tries = tries + 1
            print (' There has been a little problem, try again to resolve')
    return lyrics
